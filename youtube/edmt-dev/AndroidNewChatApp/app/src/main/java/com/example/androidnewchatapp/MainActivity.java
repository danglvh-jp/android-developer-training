package com.example.androidnewchatapp;
...
import com.example.androidnewchatapp.Common.Common;
            ...
            Dexter.withContext(this).withPermissions(Arrays.asList(
                ...
                public void onPermissionsChecked(MultiplePermissionsReport multiplePermissionsReport) {
                    if (multiplePermissionsReport.areAllPermissionsGranted()) {
                        ...
                        displayToast("Please enable all permission");
                    }
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable @org.jetbrains.annotations.Nullable Intent data) {
        ...
        if (requestCode == LOGIN_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                displayToast("[ERROR]" + response.getError());
            }
